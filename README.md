...
As of the post-hardening acceptance on 7 September 2026, the three public-candidate Markdown distribution mirrors (`Skill-Judge.md`, `Debate-Judge.md`, and `.claude/skills/debate-judge/SKILL.md`) are byte-identical at SHA-256 `81863147ed0a9833e1380e92e631022b5b5c63157822c874f981c5d30413ba09`, with MIT frontmatter. The rebuilt `web/judge.html` is SHA-256 `7753c917b0b9097f53cbeec894b48734a4ddf86b9f91cccd7523c65860688710`; `tests/run-public.js` ended with `PUBLIC TEST SUITE PASS`; the executable secret scan passed across 84 scanned files; and all release postconditions (mirror equality, MIT propagation, artwork exclusion, private-path exclusion, no API-config instance) passed. The accepted manifest is regenerated after documentation updates before Git bootstrap.
