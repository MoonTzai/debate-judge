...
These references are scholarly attribution and conceptual vocabulary. The MIT License applies to Debate-Judge's own implementation and expression; it does not purport to license third-party theories, publications, trademarks, or other independently owned works.
